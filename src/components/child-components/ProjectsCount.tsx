...
const ProjectsCount: React.FC = () => {
  useEffect(() => {
    const statContainers =
      document.querySelectorAll<HTMLElement>(".stat-container");
    ...
    function onScroll() {
      statContainers.forEach((div, i) => {
        if (isElementInViewport(div) && !hasCounted[i]) {
          ...
          const partnersCountCountElement =
            document.getElementById("partnersCount");
          ...
          if (partnersCountCountElement)
            countUp(partnersCountCountElement, 0, 14, 2000);
        }
      });
    }
  ...
  return (
    <section id="projects" className="container my-5">
      ...
      <div className="row gap-3 justify-content-center text-center">
        <div
          className="col-md-4 stat-container"
          data-aos="fade-up"
          data-aos-delay="400"
        >
          <div
            className="count-container light-background"
            style={{ borderRadius: "30px" }}
          >
            <p className="stat" id="projectCount">
              0
            </p>
          </div>
        ...
        >
          ...
          >
            <p className="stat" id="clientsCount">
              0
            </p>
          </div>
          <p>Happy Clients</p>
        ...
        >
          <div
            ...
            style={{ borderRadius: "15px" }}
          >
            <p className="stat" id="partnersCount">
              0
            </p>
          </div>
        ...
        >
          <div
            ...
            style={{ borderRadius: "15px" }}
          >
            <p className="stat" id="awardsCount">
              0
            </p>
          </div>
          <p>Awards Won</p>
